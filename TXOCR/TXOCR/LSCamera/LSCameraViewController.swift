...
open class LSCameraViewController: UIViewController {
    ...
    public weak var cameraDelegate: LSCameraDelegate?
    ...
    public func startVideoRecording() {
        ...
        sessionQueue.async { [unowned self] in
            if !movieFileOutput.isRecording {
                ...
                movieFileOutput.startRecording(to: URL(fileURLWithPath: outputFilePath), recordingDelegate: self as! AVCaptureFileOutputRecordingDelegate)
    ...
    fileprivate func addVideoInput() {
        switch currentCamera {
        case .front:
            videoDevice = LSCameraViewController.deviceWithMediaType(AVMediaType.video.rawValue, preferringPosition: .front)
        case .rear:
            videoDevice = LSCameraViewController.deviceWithMediaType(AVMediaType.video.rawValue, preferringPosition: .back)
        }
...
extension LSCameraViewController : AVCaptureFileOutputRecordingDelegate {
...
extension LSCameraViewController {
...
extension LSCameraViewController : UIGestureRecognizerDelegate {
